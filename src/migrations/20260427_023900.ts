...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_status_timeline_status" AS ENUM('processing', 'completed', 'cancelled', 'refunded');
  ...
  CREATE TYPE "public"."enum_transactions_payment_method" AS ENUM('cash-on-delivery', 'stripe');
  ...
  CREATE TABLE "orders_status_timeline" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"status" "enum_orders_status_timeline_status" NOT NULL,
  ...
  CREATE TABLE "transactions" (
  	...
  	"cash_on_delivery_note" varchar DEFAULT 'Payment will be collected on delivery.',
  	"stripe_customer_i_d" varchar,
  	"stripe_payment_intent_i_d" varchar,
  	"billing_address_district" varchar NOT NULL,
  	"billing_address_full_address" varchar NOT NULL,
  ...
  ALTER TABLE "orders_status_timeline" ADD CONSTRAINT "orders_status_timeline_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "orders_status_timeline_order_idx" ON "orders_status_timeline" USING btree ("_order");
  CREATE INDEX "orders_status_timeline_parent_id_idx" ON "orders_status_timeline" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "orders_status_timeline" CASCADE;
  ...
  DROP TYPE "public"."enum_orders_status_timeline_status";
