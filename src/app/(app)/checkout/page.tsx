...
export default function Checkout() {
  return (
    <div className="mx-auto flex min-h-[90vh] w-full min-w-0 flex-col px-4 pb-12 sm:px-6 sm:pb-16 md:px-10">
      <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-6 pt-4 sm:gap-10 sm:pt-8 md:gap-12 md:pt-12">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div className="space-y-2">
              ...
              <p className="max-w-xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                Three quick steps — contact, delivery, then review. Your details stay private to
                this order.
              </p>
            </div>
            <div className="hidden items-center gap-2 rounded-lg border bg-muted/40 px-3 py-2 text-xs text-muted-foreground sm:flex md:text-sm">
