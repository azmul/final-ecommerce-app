  ...
  return (
    ...
    >
      <div className="flex items-end justify-between text-sm grow font-semibold ">
        ...
        <Price
          amount={amount}
          className="flex-none rounded-full border border-neutral-200 bg-white/70 px-3 py-2 leading-none tracking-tight text-foreground backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white"
