...
function FacebookIcon() {
  return (
    <svg aria-hidden className="size-5" viewBox="0 0 24 24">
      <path
        d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.234 2.686.234v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"
        fill="#1877F2"
      />
    </svg>
  )
...
export const SocialLoginButtons: React.FC<SocialLoginButtonsProps> = ({
  ...
  const redirect = useMemo(() => {
    if (redirectProp) {
      return getSafeRedirectPath(redirectProp) || '/account'
    }
      ...
      <div className="flex flex-col gap-3">
        {hasGoogle ? (
          <Button asChild className="w-full" size="lg" type="button" variant="outline">
            <a href={`/api/auth/google?redirect=${redirectQuery}`}>
              <GoogleIcon />
        ...
        {hasFacebook ? (
          <Button asChild className="w-full" size="lg" type="button" variant="outline">
            <a href={`/api/auth/facebook?redirect=${redirectQuery}`}>
              <FacebookIcon />
