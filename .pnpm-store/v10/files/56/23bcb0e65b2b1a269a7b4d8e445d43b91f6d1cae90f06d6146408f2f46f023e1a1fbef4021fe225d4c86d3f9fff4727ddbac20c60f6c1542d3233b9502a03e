...
import { escapeDiffHTML, FieldDiffContainer, getHTMLDiffComponents, unescapeDiffHTML, useTranslation } from '@payloadcms/ui';
...
export const Select = t0 => {
  ...
  const t1 = "<p>" + escapeDiffHTML(renderedValueFrom) + "</p>";
  const t2 = "<p>" + escapeDiffHTML(renderedValueTo) + "</p>";
  let t3;
